...
export function PollCard({ 
  ...
  return (
    <article className="rounded-2xl bg-white p-5 shadow-sm dark:bg-gray-800 dark:text-gray-100 dark:shadow-none">
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-50">{title}</h3>
          <p className="text-sm text-gray-500 dark:text-gray-300">{meta}</p>
        </div>
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button 
          onClick={onSecondary} 
          className="rounded-xl border border-gray-200 px-4 py-2 hover:bg-gray-50 transition dark:border-gray-700 dark:text-gray-100 dark:hover:bg-gray-700"
        >
          Результаты
        </button>
      </div>
